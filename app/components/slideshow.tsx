...
export default function SlideShow() {
  ...
  <div className="border border-transparent absolute inset-0 overflow-hidden">
      ...
      {images.map((each, index) => (
        <div key={index} className="flex justify-center items-center w-screen h-screen relative">
          ...
          {differentheadings[index] && (
            <div className="bg-transparent absolute left-1/2 transform -translate-x-1/2 text-left text-white border border-transparent">
              <div className="p-6">
