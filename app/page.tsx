...
<div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center" style={{ paddingTop: '10vh' }}> {/* Inline styles to position text at the top with padding */}
