  ...
  <div className="relative w-full md:w-3/4 lg:w-2/3">
    ...
    <section className = "bg-white border-b py-8">
      ...
      <div className = "flex flex-wrap">
        ...
        <p className = "text-gray-600 mb-8"> ELD Logging, an integral component of modern fleet management, ensures meticulous tracking of vehicle activity. At Navito, our ELD Logging system stands out for its precision and thorough monitoring capabilities. We pride ourselves on delivering accurate data that enables seamless compliance with regulatory standards while optimizing operational efficiency. Moreover, our solution is highly scalable, catering to the tracking needs of multiple fleets, regardless of size or complexity. With Navito, rest assured that your fleet management endeavors are backed by reliable and adaptable ELD Logging solutions. </p> 
      ...
      <div className = "flex flex-wrap">
        ...
        <p className = "text-gray-600 mb-8"> At Navito, our fleet management solution offers a comprehensive approach to optimizing vehicle operations and enhancing overall efficiency. With our advanced technology, businesses can streamline their fleet management processes, from vehicle tracking to maintenance scheduling. Our system meticulously tracks every aspect of fleet activity, ensuring accuracy and reliability in all tracking data. By providing real-time insights into vehicle locations, performance metrics, and driver behavior, we empower businesses to make informed decisions and improve operational efficiency. Trust Navito for a fleet management solution that is efficient, reliable, and carefully tracked to deliver accurate results at every turn. </p> 
        <Link href="/MoreInfo" className=" shadow-2xl relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-white-600 border-2 border-black-600 rounded-full hover:text-white group hover:bg-gray-50">
        			<span className="absolute left-0 block w-full h-0 transition-all bg-purp opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease"></span>
       				 <span className="absolute right-0 flex items-center justify-start w-10 h-10 duration-300 transform translate-x-full group-hover:translate-x-0 ease">
          			<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
      ...
      <div className = "flex flex-wrap flex-col-reverse sm:flex-row"> 
        ...
        <div className = "w-full sm:w-1/2 p-6 mt-6"> 
          ...
          <p className = "text-gray-600 mb-8"> At Navito, our geolocation services are second to none, delivering excellent and accurate results for your vehicle monitoring needs. Our software harnesses advanced technology to provide real-time tracking and precise location data, ensuring that you always have a clear understanding of your fleet&apos;s whereabouts. With a simple and intuitive interface, our software makes it easy to visualize the location of your devices at any given time. Whether you&apos;re managing a single vehicle or an entire fleet, trust Navito to provide reliable geolocation solutions that offer peace of mind and unparalleled visibility into your operations. </p> 
          <Link href="/BookNow" className=" shadow-2xl relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-white-600 border-2 border-black-600 rounded-full hover:text-white group hover:bg-gray-50">
        			<span className="absolute left-0 block w-full h-0 transition-all bg-purp opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease"></span>
       				 <span className="absolute right-0 flex items-center justify-start w-10 h-10 duration-300 transform translate-x-full group-hover:translate-x-0 ease">
          			<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
      ...
      <div className = "flex flex-col w-full"> 
        <div>
          ...
          <p className = "leading-normal mx-auto my-4 w-10/12 sm:w-7/12 lg:w-6/12"> Whether you&apos;re tracking assets, managing fleets, or ensuring safety, Navito has you covered. Our cutting-edge technology harnesses the latest in GPS innovation, guaranteeing accurate location data every time </p>
        </div>
