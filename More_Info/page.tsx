...
export default function More_Info() {
  ...
  <div className="lg:w-1/2 bg-gray-200 p-8">
    <h2 className="text-2xl font-bold mb-4 flex justify-center items-center">Contact Us for a FREE demo</h2>
    <h3 className= "text-xl mb-4 flex justify-center items-center"> Take the first step in expanding your business with our technology </h3>
